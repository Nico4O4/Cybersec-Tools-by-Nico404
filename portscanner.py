...
while True: # Endlosschleife für den Portscanner
    ...
    while True: # Endlosschleife für das Menü
        menu = input("'Q' = Neue IP Adresse | 'E' = Beenden  ").strip().upper() # Menü für den Portscanner
        
        if menu == "E": # wenn man "E"eingibt wird das Programm beendet
            print("beendet ")
            exit()
    
        elif menu == "Q": # wenn man "Q" eingibt wird die Schleife neu gestartet    
            continue  
